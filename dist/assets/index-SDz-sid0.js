...
`;class z extends K{constructor(){super(),T(this,"props",I),T(this,"list",I.list),T(this,"object",I.object),T(this,"color",I.color),T(this,"colors",I.colors),console.log("add",this)}add(){this.list.push(Math.random()*100)}addToInnerList(t){this.object.objectList[t].innerList.push(Math.random()*10)}addObject(){this.object.objectList.push({a:"a",b:"b",c:"c",id:Math.random()*10,innerList:[1,2,3,4]})}}T(z,"config",{selector:"my-loop",template:Bt,styles:`
    ...
    `});z.register(z);function bt(e,t,r){return t=Ft(t),t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function Ft(e){var t=Vt(e,"string");return typeof t=="symbol"?t:String(t)}function Vt(e,t){if(typeof e!="object"||!e)return e;var r=e[Symbol.toPrimitive];if(r!==void 0){var n=r.call(e,t||"default");if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(e)}const Kt=`<div class="example-section-container bg-{{this.color}}-100 ">\r
  <h1>Slots:</h1>\r
  <h3>\r
...
\r
 ...
 \r
  ...
  <p>\r
    <label class="visible">\r
      Is the input displaying "render"?: {{caption == "render" }}\r
      \r
    </label>\r
  </p>\r
...
</section>`;class j extends de{constructor(){super(),w(this,"title","El Upgrade"),w(this,"description","Element framework made with ❤️ by Pihh"),w(this,"caption","Edit this caption!!"),w(this,"propagation","Propagated data"),w(this,"color","blue"),w(this,"colors",["white","yellow","green","red","blue"].map(t=>({id:t,name:t}))),w(this,"counter",0),w(this,"visible",!1)}onClick(t){console.log("onclick",t),this.counter++}}w(j,"config",{selector:"el-upgrade",template:me,styles:""});w(j,"props",["title","description","caption","propagation","color","colors","counter","visible"]);w(j,"actions",[]);j.register(j);
